...
// ant design
import { AudioOutlined,BarsOutlined, PictureOutlined} from "@ant-design/icons";
    ...
    <div>
        ...
        <div className="flex flex-col items-center justify-center p-4">
          <div className="border p-4 rounded-lg">
            <div className="flex flex-col md:flex-row md:items-end space-y-2 md:space-y-0 md:space-x-2 mb-4">
              <div>
                <label htmlFor="asset-number" className="block text-sm font-medium text-gray-700">
                  หมายเลขครุภัณฑ์
                </label>
              ...
              <div>
                ...
                {/* Dropdown สำหรับผู้ดูแล */}
                {/* เพิ่ม Dropdown สำหรับผู้ดูแลในขณะที่ไม่มีข้อมูลการดึง */}
                <Select defaultValue="ไม่มีข้อมูล" id="admin" style={{ width: 200 }} disabled>
                  <Option value="ไม่มีข้อมูล">ไม่มีข้อมูล</Option>
                  <Option value="ไม่มีข้อมูล2">ไม่มีข้อมูล2</Option>
                </Select>
              </div>
              <div>
                ...
                {/* Dropdown สำหรับที่ตั้ง */}
                {/* เพิ่ม Dropdown สำหรับที่ตั้งในขณะที่ไม่มีข้อมูลการดึง */}
                <Select defaultValue="ไม่มีข้อมูล" id="location" style={{ width: 200 }} disabled>
                  <Option value="ไม่มีข้อมูล">ไม่มีข้อมูล</Option>
                </Select>
              </div>
            </div>
            <div className="flex justify-end">
              <Button className="text-gray-800 bg-gray-300" type="primary">
                ค้นหา
              </Button>
            </div>
          </div>
      ...
      <div>
        <Link to="/AddInventory">
          <button className="btn btn-outline btn-success">เพิ่มครุภัณฑ์</button>
        </Link>
      </div>
